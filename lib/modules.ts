...
export const MODULES: ModuleDef[] = [
  ...
  // Anyone can report something broken; RLS shows them only their own.
  { key: "maintenance", label: "Maintenance", href: "/maintenance", icon: "wrench", accent: "#78350f", ready: true },
